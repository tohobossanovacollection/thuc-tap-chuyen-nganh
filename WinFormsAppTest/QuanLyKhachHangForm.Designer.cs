...
namespace WinFormsAppTest
{
    partial class QuanLyKhachHangForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // _btnHistory
            // 
            _btnHistory.BorderColor = Color.White;
            _btnHistory.BorderRadius = 8;
            _btnHistory.BorderThickness = 1;
            _btnHistory.FillColor = Color.FromArgb(255, 167, 38);
            _btnHistory.ForeColor = Color.Black;
            _btnHistory.Font = new Font("Segoe UI", 9F);
            _btnHistory.Location = new Point(1040, 22);
            _btnHistory.Name = "_btnHistory";
            _btnHistory.Size = new Size(120, 40);
