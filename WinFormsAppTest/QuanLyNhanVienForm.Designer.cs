...
namespace WinFormsAppTest
{
    partial class QuanLyNhanVienForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // btnGanTk
            // 
            btnGanTk.BorderColor = Color.White;
            btnGanTk.BorderRadius = 8;
            btnGanTk.BorderThickness = 1;
            btnGanTk.FillColor = Color.FromArgb(255, 167, 38);
            btnGanTk.ForeColor = Color.Black;
            btnGanTk.Font = new Font("Segoe UI", 9F);
            btnGanTk.Location = new Point(1040, 22);
            btnGanTk.Name = "btnGanTk";
            btnGanTk.Size = new Size(120, 40);
            btnGanTk.TabIndex = 5;
